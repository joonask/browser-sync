...
var messages = {
    ...
    socketConnector: function (port, options) {
        ...
        var path = objectPath.get(options, "socketConfig.path", "/socket.io");
        var namespace = objectPath.get(options, "socketConfig.namespace", "/browser-sync");

        port = 8080; // TODO get DW server port here
        console.log("Client event socket port: " + port + " namespace: " + namespace);
